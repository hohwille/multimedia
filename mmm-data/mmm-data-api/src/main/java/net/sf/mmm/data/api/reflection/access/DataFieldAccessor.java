 ...
 * {@link #setFieldValue(DataObject, Object) write} a {@link net.sf.mmm.data.api.reflection.DataField field} of a
 * {@link DataObject}. According to the {@link net.sf.mmm.data.api.reflection.DataField#getModifiers() modifiers} the
 * field may be {@link net.sf.mmm.data.api.reflection.DataFieldModifiers#isReadOnly() read-only}. Then the write access
 * will NOT be allowed and therefore fail.
 *
 * @param <CLASS> is the generic type for the bound of {@link net.sf.mmm.data.api.reflection.DataField#getJavaClass()}.
...
public interface DataFieldAccessor<CLASS extends DataObject, FIELD> {
  ...
  /**
   * This method sets the field in the <code>object</code> to the given <code>value</code>. The field must NOT be
   ...
   * @throws ReadOnlyException if the field is {@link net.sf.mmm.data.api.reflection.DataFieldModifiers#isReadOnly()
   *         read-only}.
   * @throws NlsClassCastException if the given <code>value</code> is not compatible with the
   *         {@link net.sf.mmm.data.api.reflection.DataField#getFieldType() type} of the field.
   * @throws SecurityException is the access failed for security reasons.
